...
export default function ReviewSection() {
  ...
  return (
     <div className="relative w-full flex justify-center items-center md:py-12">
          <GridBackground className="absolute left-1/2 -translate-x-1/2 w-full md:min-w-[2700px] min-w-[2000px] z-0"/>
          <div ref={scrollRef} className="flex gap-4 z-20 overflow-x-hidden">
            <Review1 className="md:min-w-[433px] min-w-[310px]"/>
            <Review2 className="md:min-w-[433px] min-w-[310px]"/>
            <Review3 className="md:min-w-[433px] min-w-[310px]"/>
            <Review4 className="md:min-w-[433px] min-w-[310px]"/>
            <Review5 className="md:min-w-[433px] min-w-[310px]"/>
            <Review6 className="md:min-w-[433px] min-w-[310px]"/>
          </div>
    </div>
  )
}