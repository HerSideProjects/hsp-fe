...
export default function Hero() {
    return (
        <section className="mx-8 relative bg-[#EF3187] bg-cover bg-center overflow-hidden rounded-3xl shadow-xl px-8 pt-8 md:px-12 md:pt-8 text-white" style={{ backgroundImage: "url('/assets/images/bg-hero.png')" }}>
            <div className="flex flex-col md:flex-row">
                <div className="order-1 md:order-2 md:w-2/5 flex md:justify-end mt-4 md:mt-0">
                    <Magnifier className="md:p-10 w-[30%] md:block md:w-[71%] max-w-sm md:max-w-full h-auto object-contain self-center"/>
                </div>
