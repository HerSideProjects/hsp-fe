export const options = [
  // Content & Creative
  { label: "TikTok Content", value: "TikTok Content" },
  ...
  { label: "Pinterest-ing", value: "Pinterest-ing" },
  { label: "Editing Reels", value: "Editing Reels" },
  ...
  { label: "Netflix Binge", value: "Netflix Binge" },
  { label: "Concert Going", value: "Concert Going" },
  { label: "Fandom Life", value: "Fandom Life" },
