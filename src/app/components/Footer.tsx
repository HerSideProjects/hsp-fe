...
export default function Footer() {
  ...
  return (
    <footer className="relative bottom-0 left-0 right-0 bg-white overflow-hidden">
      ...
      <div className="relative bg-[#aec4ff] text-[#1e0c2b] px-4 py-6 md:py-4">
      <div className="absolute bottom-0 right-0 w-32 md:w-48 opacity-30 pointer-events-none">
        <Image
      ...
      <div className="z-10 max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-6">
        <div className="flex-1 max-w-4xl">
          <div className="mb-2">
            <Image src="/assets/images/Icon-Black.png" alt="HerSideProject Logo" width={80} height={10} />
          </div>
