...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-[#FEF6EB] z-10">
      <Navbar />
      <main className="flex-1 pt-28 px-8 pb-96">
        <div className="max-w-8xl mx-auto">
          <section className="relative bg-[#EF3187] bg-cover bg-center overflow-hidden rounded-3xl shadow-xl p-8 md:p-12 text-white" style={{ backgroundImage: "url('/assets/images/bg-hero.png')" }}>
            <div className="flex flex-col md:flex-row">
              <div className="md:w-3/5 pt-4">
                ...
                <h1 className="text-[64px] md:text-[120px] leading-none mb-4 text-white" style={{ fontFamily: 'Losta Masta Medium, sans-serif' }}>
                  Her Side <br /> Project
                </h1>
