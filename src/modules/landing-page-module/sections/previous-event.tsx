...
const carouselImages = [
  '/assets/images/prev-event-vol1/carousel/foto1.webp',
  '/assets/images/prev-event-vol1/carousel/foto2.webp',
  '/assets/images/prev-event-vol1/carousel/foto3.webp',
  '/assets/images/prev-event-vol1/carousel/foto4.webp',
  '/assets/images/prev-event-vol1/carousel/foto5.webp',
  '/assets/images/prev-event-vol1/carousel/foto6.webp',
  '/assets/images/prev-event-vol1/carousel/foto7.webp',
]
  ...
  return (
    <div className="relative w-full">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/assets/images/prev-event-vol1/cardboard.webp')" }}
      >
